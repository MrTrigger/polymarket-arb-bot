...
fn test_pnl_report_contains_required_fields() {
    let result = BacktestResult {
        ...
        fees_paid: dec!(25),
        rebates_earned: rust_decimal::Decimal::ZERO,
...
// =============================================================================
// NOTE: Account scaling tests removed during config simplification.
// Sizing is now controlled directly via base_order_size in config.
